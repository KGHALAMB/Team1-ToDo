(function () {
  ...
  (t = {}),
    ...
    (t.IPv4.parse = function (r) {
      var t;
      if (null === (t = this.parser(r)))
        throw new Error('ipaddr: string is not formatted like ip address');
      return new this(t);
    }),
    (t.IPv6.parse = function (r) {
      var t;
      if (null === (t = this.parser(r)).parts)
        throw new Error('ipaddr: string is not formatted like ip address');
    ...
    (t.IPv4.broadcastAddressFromCIDR = function (r) {
      ...
      try {
        ...
        throw (
          (r, new Error('ipaddr: the address does not have IPv4 CIDR format'))
        );
      }
    }),
